...
class TestParseTree(unittest.TestCase):
    ...
    def test_only_text(self):
        ...
        expected_tree = RootTag({}, [RawText("Hello, World!"),], "", "")
    ...
    def test_invalid_close_tag(self):
        ...
        expected_tree = RootTag(
            ...
            [
                Tag1(
                    (),
                    [ErrorText("[/banana]"), ErrorText("[/notexist]"),],
                    "[cheese]",
                    "[/cheese]",
                )
            ],
    ...
    def test_custom_tag_set(self):
        ...
        expected_tree = RootTag(
            ...
            [
                OuterTag(
                    (),
                    [InnerTag((), [RawText("Hello!")], "[inner]", "[/inner]",)],
                    "[banana]",
                    "[/banana]",
                )
            ],
    ...
    def test_tag_no_close_brace(self):
        ...
        expected_tree = RootTag({}, [ErrorText("[imgoingtobreak"),], "", "")
    ...
    def test_bad_tag_syntax(self):
        ...
        expected_tree = RootTag({}, [ErrorText("[this is really broken!]")], "", "")
    ...
    def test_close_not_opened_tag(self):
        ...
        expected_tree = RootTag({}, [ErrorText("[/apple]")], "", "")
    ...
    def test_empty_tag(self):
        ...
        expected_tree = RootTag({}, [ErrorText("[]")], "", "")
    ...
    def test_close_outer_tag(self):
        ...
        expected_tree = RootTag(
            {},
            [Tag1((), [ErrorText("[b]")], "[a]", "[/a]"), ErrorText("[/b]"),],
            "",
            "",
        )
            ...
            [
                OuterTag1(
                    ...
                    [
                        ...
                        InnerTag2((), [], "[inner-b]", ""),
                        OuterTag1.null_class(
                            (), [RawText("fail")], "[outer-banana]", "[/outer-banana]"
                        ),
                        OuterTag2.null_class(
                            (),
                            [RawText("also fail")],
                            "[outer-apple]",
                            "[/outer-apple]",
                ...
                OuterTag2(
                    ...
                    [
                        InnerTag1(
                            (), [RawText("This works!")], "[inner-a]", "[/inner-a]"
                        ),
                        ErrorText("[inner-b]"),
                        OuterTag1.null_class(
                            (),
                            [RawText("also also also fail")],
                            "[outer-banana]",
                            "[/outer-banana]",
                        ),
                        OuterTag2.null_class(
                ...
                ErrorText("[inner-a]"),
                RawText("Should be inside something!"),
                ErrorText("[/inner-a]"),
                ErrorText("[inner-b]"),
            ],
            "",
    ...
    def test_tag_ctx_honoured_in_error_short_circuit_closetag(self):
        ...
        expected_tree = RootTag(
            {},
            [OuterTag((), [ErrorText("[B]"), ErrorText("[C]"),], "[A]", "[/A]",),],
            "",
            "",
        )
    ...
    def test_tag_ctx_honoured_in_error_short_circuit_newline(self):
        ...
        expected_tree = RootTag(
            {},
            [
                OuterTag((), [ErrorText("[B]"), ErrorText("[C]"),], "[A]", "",),
                NewlineText("\n"),
            ],
            "",
            "",
    ...
    def test_tag_ctx_honoured_in_error_EOF(self):
        ...
        expected_tree = RootTag({}, [ErrorText("[A]"), ErrorText("[B]"),], "", "")
...
class TestTreeParserContext(unittest.TestCase):
    def test_context_passed(self):
        class Bold(MockBaseTag):
            ...
            def _render(self):
                ...
                return "<b>{bold}. {children}</b>".format(
                    bold=ctx.get("b"), children=self.render_children(),
                )
        ...
        class Italic(MockBaseTag):
            ...
            def _render(self):
                ...
                return "<i>{italic}. {children}</i>".format(
                    italic=ctx.get("i"), children=self.render_children()
                )
        ...
        inst = TestParser(input_text)
        result_text = inst.render(ctx={"b": "bold", "i": "italic",})
    ...
    def test_context_updates(self):
        class Bold(MockBaseTag):
            ...
            def _render(self):
                return "<b>{bold}. {children}</b>".format(
                    bold="italic", children=self.render_children(),
                )
    ...
    def test_context_tag_updates(self):
        class Bold(MockBaseTag):
            ...
            def _render(self):
                ctx = self.get_context()
                return "<b>{bold}. {children}</b>".format(
                    bold=ctx.get("b", "BOLD"), children=self.render_children(),
                )
        ...
        class Italic(MockBaseTag):
            ...
            def _render(self):
                ctx = self.get_context()
                return "<i>{italic}. {children}</i>".format(
                    italic=ctx.get("i", "ITALIC"), children=self.render_children()
                )
        ...
        inst = TestParser(input_text)
        result_text = inst.render(ctx={"b": "NOT BOLD",})
